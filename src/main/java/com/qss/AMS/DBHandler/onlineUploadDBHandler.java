...
public class onlineUploadDBHandler {
  ...
  private String apiURI = "http://ams-agri.qsslanka.com/api";

//    private String apiURI = "http://127.0.0.1:8000/api";
    ...
    public int uploadEmployees( String to, String branchname){
        ...
        try {
            URL url = new URL(this.apiURI + "/employee/readmax?searchInput="+branchname);
            ...
            System.out.println(conn.getResponseCode()+" Output from Server .... \n");
        ...
        try{
            ...
            while(rs.next()){
                ...
                try {
                    URL url = new URL(this.apiURI+"/employee/write");
                    HttpURLConnection conn = (HttpURLConnection) url.openConnection();
    ...
    public int uploadLeavesbyDuration(String to, String branchname){
        ...
        try {
            URL url = new URL(this.apiURI+"/leave/readmax?searchInput="+branchname);
            System.out.println(url);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
            conn.setRequestMethod("GET");
            conn.setRequestProperty("Accept", "application/json");
       ...
       /* ArrayList<Users> leaveList = new ArrayList<>();
        ...
        try{
            ...
            while(rs.next()){
                ...
                try {
                    URL url = new URL(this.apiURI+"/leave/write");
                    HttpURLConnection conn = (HttpURLConnection) url.openConnection();
                    conn.setDoOutput(true);
                    conn.setRequestMethod("POST");
                    conn.setRequestProperty("Content-Type", "application/json");
    ...
    public int uploadAttendanceByDuration( String to, String branchname){
        ...
        try {
            URL url = new URL(this.apiURI+"/attendance/readmax?searchInput="+branchname);
            System.out.println(url);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
            conn.setRequestMethod("GET");
            conn.setRequestProperty("Accept", "application/json");
        ...
        try{
            ...
            while(rs.next()){
                ...
                try {
                    URL url = new URL(this.apiURI+"/attendance/write");
                    HttpURLConnection conn = (HttpURLConnection) url.openConnection();
                    conn.setDoOutput(true);
                    conn.setRequestMethod("POST");
                    conn.setRequestProperty("Content-Type", "application/json");
    ...
    public int uploadOtByDuration( String to, String branchname){
        ...
        String finalJsonString = "{\"data\":[{\"clock\":\"2005-05-05 05:05:05\"}]}";;
        try {
            URL url = new URL(this.apiURI+"/ot/readmax?searchInput="+branchname);
            System.out.println(url);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
            conn.setRequestMethod("GET");
            conn.setRequestProperty("Accept", "application/json");
        ...
        try{
            ...
            while(rs.next()){
                ...
                try {
                    URL url = new URL(this.apiURI+"/ot/write");
                    HttpURLConnection conn = (HttpURLConnection) url.openConnection();
                    conn.setDoOutput(true);
                    conn.setRequestMethod("POST");
                    conn.setRequestProperty("Content-Type", "application/json");
