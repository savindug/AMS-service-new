...
//    private String apiURI = "http://127.0.0.1:8000/api";
    ...
    public ArrayList<Users> downloadEmployees(String branchname){
        ...
        try {
            URL url = new URL(this.apiURI+ "/employee/read?searchInput="+branchname);
    ...
    public ArrayList<Users> downloadLeaves(String from, String to, String branchname){
        ...
        try {
            ...
            URL url = new URL(this.apiURI+"/leave/read?searchInput="+branchname+"&searchClock1="+sqlDate1+"&searchClock2="+sqlDate2);
            System.out.println(url);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
            conn.setRequestMethod("GET");
            conn.setRequestProperty("Accept", "application/json");
    ...
    public ArrayList<Attendance> downloadAttendance(String from, String to, String branchname){
        ...
        try {
            ...
            URL url = new URL(this.apiURI+"/attendance/read?searchInput="+branchname+"&searchClock1="+sqlDate1+"&searchClock2="+sqlDate2);
            System.out.println(url);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
            conn.setRequestMethod("GET");
            conn.setRequestProperty("Accept", "application/json");
    ...
    public ArrayList<Attendance> downloadOt(String from, String to, String branchname){
        ...
        try {
            ...
            URL url = new URL(this.apiURI+"/ot/read?searchInput="+branchname+"&searchClock1="+sqlDate1+"&searchClock2="+sqlDate2);
            System.out.println(url);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
            conn.setRequestMethod("GET");
            conn.setRequestProperty("Accept", "application/json");
